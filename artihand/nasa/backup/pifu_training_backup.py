...
class Trainer(BaseTrainer):
    ...
    def eval_step(self, data):
        ...
        with torch.no_grad():
            left_p_out, right_p_out = self.model(imgs, (left_root_rot_mat, right_root_rot_mat), (left_points_iou, right_points_iou), (left_inputs, right_inputs), bone_lengths=(left_bone_lengths, right_bone_lengths),
    ...
    def visualize(self, data):
        ...
        kwargs = {}
        with torch.no_grad():
            left_p_r, right_p_r = self.model(imgs, root_rot_mat, p, inputs, bone_lengths=bone_lengths, sample=self.eval_sample, **kwargs)
    ...
    def compute_loss(self, data):
        ...
        if self.use_sdf:
            ...
            left_pred, right_pred = self.model.decode(img_feat, camera_params, (left_root_rot_mat, right_root_rot_mat), (left_p, right_p), (left_c, right_c), bone_lengths=(left_bone_lengths, right_bone_lengths), **kwargs)
            # print("pred", pred)
            # print("occ", occ)
