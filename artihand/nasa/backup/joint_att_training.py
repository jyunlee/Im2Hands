...
class Trainer(BaseTrainer):
    ...
    def eval_step(self, data):
        ...
        img, mask, dense, camera_params, mano_data, idx = data
    ...
    def compute_loss(self, data):
        ...
        img, mask, dense, camera_params, mano_data, _ = data
        imgs = (img, mask, dense, camera_params)
        ...
        img, mask, dp, camera_params, mano_data, _ = data
        ...
        if joint_only:
            ...
            loss *= 1000
            loss_dict['total'] = loss_dict['joints_err'] = loss.item()
